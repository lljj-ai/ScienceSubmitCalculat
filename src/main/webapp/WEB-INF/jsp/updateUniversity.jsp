...
%>
<body>
      <form action="/university/updateUniversityById" method="get" name="form3">
      <table align="center" class="table table-bordered table-hover ">
         <tr>
         <td>学校Id:</td>
         <td><input name="universityId" type="text"  class="form-control" 
           value="${university.getUniversityId()}" /></td>
         </tr>
         <tr>
         <td>学校名称:</td>
         <td><input name="universityName" type="text" class="form-control"/></td>
         </tr>
         <tr>
         <td>学校等级:</td>
         <td><input name="universityGrade" type="text" class="form-control"/></td>
         </tr>
         <tr>
         <td>学科类型:</td>
         <td><input name="universityType" type="text" class="form-control"/></td>
         </tr>
         <tr>
         <td></td>
