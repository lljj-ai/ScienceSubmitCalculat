...
<header  class="container">
   ...
   <br><br><br><br><br>
	...
	<h1>高校科研提交与统计后台管理系统</h1>
        ...
        <center>
        <h1>添加学院</h1>
        <form action="/department/insertDepartment" method="post" name="form1"
       >
           <table align="center" valign="middle"
             class="table table-bordered table-hover " >     <!--利用表格来使文本框对齐-->
	             ...
	             <tr>  <!--利用空格来使文字对齐---->
	                <td>学院名称：</td>
	                <td><input name="departmentName" class="form-control" type="text" 
	                    id="departmentName" size="20" maxlength="20" placeholder="必填"></td>
	             </tr>
	             <tr>
	                <td>学院类型：</td>
	                <td><input name="departmentType" class="form-control" type="text" 
	                    id="departmentType" size="20" maxlength="20" placeholder="必填"></td>
	             </tr>
	             <tr>
	                <td>学校ID：</td>
