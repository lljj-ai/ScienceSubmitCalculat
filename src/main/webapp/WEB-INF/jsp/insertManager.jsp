...
<header  class="container">
   ...
   <br><br><br><br><br>
	...
	<h1>高校科研提交与统计后台管理系统</h1>
        ...
        <center>
        <h1>添加管理员</h1>
        <form action="/account/insertManager" method="post" name="form1">
           <table align="center" valign="middle" class="table table-bordered table-hover ">     <!--利用表格来使文本框对齐-->
                 <hr color="#FF6433">
                 <h1>请输入管理员信息 </h1>
	             <tr>  <!--利用空格来使文字对齐---->
	                <td>管理员姓名：</td>
	                <td><input name="managerName" class="form-control" type="text" 
	                    id="managerName" size="20" maxlength="20" placeholder="必填"></td>
	             </tr>
	             <tr>
	                <td>Email：</td>
